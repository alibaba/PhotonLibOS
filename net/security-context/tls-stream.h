...
public:
    ...
    virtual unsigned long get_openssl_version() = 0;
    unsigned long make_openssl_version(unsigned long major, unsigned long minor,
              unsigned long patch = 0, unsigned long pre_release = 0) {
        return (major << 28) | (minor << 20) | (patch << 4) | pre_release;
    }
};
