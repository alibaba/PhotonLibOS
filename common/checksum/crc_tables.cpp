...
// =============================================================================
//
// For block size B bytes (B/8 uint64s), index = (B/8 - 1) * 2
...
alignas(16) const uint64_t crc32_merge_table_pclmulqdq[CRC32_MERGE_TABLE_SIZE * 2] = {
    MERGE_ENTRY(8),   MERGE_ENTRY(16),  MERGE_ENTRY(24),  MERGE_ENTRY(32),
    MERGE_ENTRY(40),  MERGE_ENTRY(48),  MERGE_ENTRY(56),  MERGE_ENTRY(64),
    MERGE_ENTRY(72),  MERGE_ENTRY(80),  MERGE_ENTRY(88),  MERGE_ENTRY(96),
    MERGE_ENTRY(104), MERGE_ENTRY(112), MERGE_ENTRY(120), MERGE_ENTRY(128),
    MERGE_ENTRY(136), MERGE_ENTRY(144), MERGE_ENTRY(152), MERGE_ENTRY(160),
    MERGE_ENTRY(168), MERGE_ENTRY(176), MERGE_ENTRY(184), MERGE_ENTRY(192),
    MERGE_ENTRY(200), MERGE_ENTRY(208), MERGE_ENTRY(216), MERGE_ENTRY(224),
    MERGE_ENTRY(232), MERGE_ENTRY(240), MERGE_ENTRY(248), MERGE_ENTRY(256),
    MERGE_ENTRY(264), MERGE_ENTRY(272), MERGE_ENTRY(280), MERGE_ENTRY(288),
    MERGE_ENTRY(296), MERGE_ENTRY(304), MERGE_ENTRY(312), MERGE_ENTRY(320),
    MERGE_ENTRY(328), MERGE_ENTRY(336), MERGE_ENTRY(344), MERGE_ENTRY(352),
    MERGE_ENTRY(360), MERGE_ENTRY(368), MERGE_ENTRY(376), MERGE_ENTRY(384),
    MERGE_ENTRY(392), MERGE_ENTRY(400), MERGE_ENTRY(408), MERGE_ENTRY(416),
    MERGE_ENTRY(424), MERGE_ENTRY(432), MERGE_ENTRY(440), MERGE_ENTRY(448),
    MERGE_ENTRY(456), MERGE_ENTRY(464), MERGE_ENTRY(472), MERGE_ENTRY(480),
    MERGE_ENTRY(488), MERGE_ENTRY(496), MERGE_ENTRY(504), MERGE_ENTRY(512),
    // blksz 520-1024
    MERGE_ENTRY(520), MERGE_ENTRY(528), MERGE_ENTRY(536), MERGE_ENTRY(544),
    MERGE_ENTRY(552), MERGE_ENTRY(560), MERGE_ENTRY(568), MERGE_ENTRY(576),
    MERGE_ENTRY(584), MERGE_ENTRY(592), MERGE_ENTRY(600), MERGE_ENTRY(608),
    MERGE_ENTRY(616), MERGE_ENTRY(624), MERGE_ENTRY(632), MERGE_ENTRY(640),
    MERGE_ENTRY(648), MERGE_ENTRY(656), MERGE_ENTRY(664), MERGE_ENTRY(672),
    MERGE_ENTRY(680), MERGE_ENTRY(688), MERGE_ENTRY(696), MERGE_ENTRY(704),
    MERGE_ENTRY(712), MERGE_ENTRY(720), MERGE_ENTRY(728), MERGE_ENTRY(736),
    MERGE_ENTRY(744), MERGE_ENTRY(752), MERGE_ENTRY(760), MERGE_ENTRY(768),
    MERGE_ENTRY(776), MERGE_ENTRY(784), MERGE_ENTRY(792), MERGE_ENTRY(800),
    MERGE_ENTRY(808), MERGE_ENTRY(816), MERGE_ENTRY(824), MERGE_ENTRY(832),
    MERGE_ENTRY(840), MERGE_ENTRY(848), MERGE_ENTRY(856), MERGE_ENTRY(864),
    MERGE_ENTRY(872), MERGE_ENTRY(880), MERGE_ENTRY(888), MERGE_ENTRY(896),
    MERGE_ENTRY(904), MERGE_ENTRY(912), MERGE_ENTRY(920), MERGE_ENTRY(928),
    MERGE_ENTRY(936), MERGE_ENTRY(944), MERGE_ENTRY(952), MERGE_ENTRY(960),
    MERGE_ENTRY(968), MERGE_ENTRY(976), MERGE_ENTRY(984), MERGE_ENTRY(992),
    MERGE_ENTRY(1000), MERGE_ENTRY(1008), MERGE_ENTRY(1016), MERGE_ENTRY(1024),
};
